                                ...
                                bool show_basis)
{
	...
	_body.spin.rotation_angle = _body.spin.rotation_angle + (elapsed_time_s * _body.spin.speed); //Ex 2.6
	...
	//Excercise 2
	glm::vec3 earth_centergrav = glm::vec3(0.0f, 0.0f, 0.0f);
	...
	//Excercise 3
	_body.orbit.rotation_angle = _body.orbit.rotation_angle + (elapsed_time_s * _body.orbit.speed); //Ex 3.3
	glm::vec3 t = glm::vec3( _body.orbit.radius, 0.0f, 0.0f); //How to access the earth_orbit variable?
	glm::mat4 To = glm::translate(I, t);
	...
	world = R1o*To*S; //Ex 3.1, 3.2, 3.4 , 3.6, 4.1
	//End excercise 3

	//Excercise 4: Calculate child's transformation
	glm::mat4 child_transform(1.0f);
	//Translate the child's center to the parent's center

	glm::mat4 t_c = glm::translate(I, glm::vec3(_body.orbit.radius, 0.0f, 0.0f));
	...
	//return parent_transform; //Original code
