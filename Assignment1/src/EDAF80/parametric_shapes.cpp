                              ...
                              unsigned int const vertical_split_count)
{
	...
	//glGenVertexArrays(1, /*! \todo fill me nullptr */nullptr);
	...
	glVertexAttribPointer(static_cast<unsigned int>(bonobo::shader_bindings::vertices),
	                      /*! \todo how many components do our vertices have? */3, //3 components
	...
	data.indices_nb = /*to-do*/ static_cast<GLsizei>(index_sets.size() * 3u);
